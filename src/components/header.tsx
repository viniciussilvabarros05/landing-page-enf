...
export const Header = () => {
  ...
  return (
    <header className="w-full m-auto flex items-center p-8 fixed top-0 left-0 bg-white/40 backdrop-blur-md shadow-md z-10">
      <Link href="/" className="w-24 h-20 absolute left-32 max-lg:left-4">
        <Image width={400} height={400} className="w-full" alt="SIOVH" src="/images/logo.png" style={{objectFit:"contain"}}/>
      </Link>
