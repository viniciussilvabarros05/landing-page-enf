...
export default function Page() {
  return (
    <Container className="pb-32 mt-16 ">
      <ButtonBack />
      ...
      <h2 className="text-lg font-bold text-blue-500 mb-8">
      ...
      <p className="text-justify">
        ...
        graves se infectados por certas doenças. O calendário de vacinação para
        esses grupos é cuidadosamente ajustado conforme as necessidades de
        proteção e as recomendações de segurança para cada condição, de modo a
        promover uma imunização segura e eficiente.
      </p>
      ...
      >
        ...
        <li>
          <strong></strong>Tratamento para câncer: pacientes que estão fazendo
        ...
        <li>
          <strong>Doenças autoimunes:</strong> pessoas que tem doenças que
          atacam o próprio corpo, como lúpus ou artrite reumatoide, entre
          outras, que estão em tratamento com medicamentos imunossupressores;
        </li>
        <li>
          <strong>Doenças crônicas graves:</strong> pacientes com doenças de
          longa duração, como problemas graves no coração, pulmões, rins,
          fígado, ou diabetes que não está bem controlada.
        </li>
        <li>
          <strong>Gestantes com necessidades especiais:</strong> grávidas que
          tenham algum problema de saúde específico e que precisam de vacinas
          diferenciadas;
        </li>
        <li>
          <strong>Bebês prematuros e recém-nascidos de risco:</strong> bebês que
          nasceram antes do tempo ou com baixo peso, o que pode deixá-los mais
        ...
        <li>
          <strong>Contato com pessoas de risco:</strong> quem mora ou cuida de
          pessoas com a imunidade baixa pode ser vacinado no CRIE para proteger
          essas pessoas.
        </li>
      </ul>
